package flower.gallery.NewCustomer;
...
public class NewCustomerController implements Initializable {
    ...
    private NewCustomerController thisController = this;
    ...
    private void setColumnProps() {
        ...
        updateColumn.setRowCellFunction(customerData -> {
            ...
            rowCell.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent -> {
                ...
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/flower/gallery/fxml/customer/customer-form.fxml"));
