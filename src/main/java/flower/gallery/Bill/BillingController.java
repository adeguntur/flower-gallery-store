...
import flower.gallery.Bill.data.BillCustomer;
...
//    private int subTotal;
    ...
    public void MovetoBooks() {
        if (!currentPage.equals("selectItemsBill")) {
            loader = new FXMLLoader(getClass().getResource("/flower/gallery/fxml/billing/selectItemsForBill.fxml"));
            try {
    ...
    public void moveToSelectCustomer() {
            ...
            loader = new FXMLLoader(getClass().getResource("/flower/gallery/fxml/billing/selectCustomerBill.fxml"));
            try {
                content.getChildren().clear();
                content.getChildren().add(loader.load());
