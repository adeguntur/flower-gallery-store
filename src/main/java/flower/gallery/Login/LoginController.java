...
import flower.gallery.controllers.mainPageController;
...
public class LoginController implements Initializable {
            ...
            if (txtUsername.isValid() || txtPass.isValid()) {
                ...
                if(rs_1.next()){
                    ...
                    if(matchedPassword == true) {
                        ...
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/flower/gallery/main-dash.fxml"));
    ...
    public void forgotOnAction(ActionEvent event2)throws IOException{
        Parent view = FXMLLoader.load(getClass().getResource("/flower/gallery/fxml/login/change-password.fxml"));
        Scene scene = new Scene(view);
